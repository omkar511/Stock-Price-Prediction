...
if __name__ == '__main__':
    fp1 = open("dataset/nifty_18_4.csv", 'r+')
    ...
    plotting_svm(predicted1, test_label1,"Plots/nifty/nifty_1.jpg",'r')
    plotting_svm(predicted2, test_label2,"Plots/nifty/nifty_2.jpg",'g')
    plotting_svm(predicted3, test_label3,"Plots/nifty/nifty_3.jpg",'b')
    plotting_svm(predicted4, test_label4,"Plots/nifty/nifty_4.jpg",'y')
