...
if __name__ == '__main__':
    fp1 = open("dataset/reliance_22_4.csv", 'r+')
    timestamp_list, close_list, high_list, low_list, open_price_list, volume_list = read_data(fp1)
    fp1.close()
    ...
    plotting_svm(predicted1, test_label1,"Plots/reliance/reliance1_1.jpg",'r')
    plotting_svm(predicted2, test_label2,"Plots/reliance/reliance1_2.jpg",'g')
    plotting_svm(predicted3, test_label3,"Plots/reliance/reliance1_3.jpg",'b')
    plotting_svm(predicted4, test_label4,"Plots/reliance/reliance1_4.jpg",'y')
