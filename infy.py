...
if __name__ == '__main__':
    fp1 = open("dataset/infy_18_4.csv", 'r+')
    ...
    plotting_svm(predicted1, test_label1,"Plots/infy/infy1_1_rbf.jpg",'r')
    plotting_svm(predicted2, test_label2,"Plots/infy/infy2_2_rbf.jpg",'g')
    plotting_svm(predicted3, test_label3,"Plots/infy/infy3_3_rbf.jpg",'b')
    plotting_svm(predicted4, test_label4,"Plots/infy/infy4_4_rbf.jpg",'y')
