...
if __name__ == '__main__':
    fp1 = open("dataset/ongc_rbf.csv", 'r+')
    ...
    plotting_svm(predicted1, test_label1,"Plots/ongc/ongc1_1.jpg",'r')
    plotting_svm(predicted2, test_label2,"Plots/ongc/ongc1_2.jpg",'g')
    plotting_svm(predicted3, test_label3,"Plots/ongc/ongc1_3.jpg",'b')
    plotting_svm(predicted4, test_label4,"Plots/ongc/ongc1_4.jpg",'y')
